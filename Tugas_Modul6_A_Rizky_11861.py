...
model = load_model(r"D:\KAMPUS LIK OJO KESET\MESIN LERNING\CNN\Tugas6_A_11861\Tugas6_A_11861\model_mobilenet.h5")
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1861")  # 4 digit npm terakhir
